<template>
    <div class="about_container p-4">
        ...
        <p class="mb-2 text-center">We are Joy Bringers, we believe that every event has the potential to be
            ...
            create memorable and impactful experiences that bring communities together. With our user-friendly platform,
            you can effortlessly plan, promote, and manage events of all sizes, from intimate gatherings to large-scale
        ...
        <div class="details_container mt-10">
            ...
            <div class="details_item opp">
                ...
                <div class="content">
                    ...
                    <div class="more_content_container">
                        <div class="fs-6 content_text">
                            Our vision is to be the premier destination for event creators and attendees alike, offering
                            a seamless and immersive experience that transcends traditional event planning boundaries.
                            We envision a world where events are not just occasions but transformative experiences that
